...
namespace LLamaHub.Core.LLamaSharp
{
    ...
    /// </summary>
    public abstract class LLamaHubStatefulExecutorBase : ILLamaHubExecutor
    {
        /// <summary>
        /// The loaded model for this executor.
        /// </summary>
        protected readonly LLamaHubModelContext _context;
        /// <summary>
        ...
        /// </summary>
        public LLamaHubModel Model => _context?.Model;
        ...
        protected LLamaHubStatefulExecutorBase(LLamaHubModelContext model, ILLamaLogger logger = null)
        {
            _context = model;
            _logger = logger;
            _pastTokensCount = 0;
